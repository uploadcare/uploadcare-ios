...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.socialImage.image = [UIImage imageNamed:[social.sourceName stringByAppendingPathExtension:@"png"] inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil];
    return cell;
}
